...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> read(@PathVariable(name = "id") @Parameter(description = "id сотрудника") Integer id) {
    ...
    public ResponseEntity<?> update(@PathVariable(name = "id") @Parameter(description = "id сотрудника") Integer id, @RequestBody Employee employee) {
    ...
    public ResponseEntity<?> changeStatus(@PathVariable(name = "id") @Parameter(description = "id сотрудника") Integer id) {
